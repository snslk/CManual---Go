...
create table users (userid varchar(20) primary key , name varchar(20) , email varchar(20) , mobile varchar(10));

insert into users values ('1','snehal','snehal@gmail.com','9988776655');
